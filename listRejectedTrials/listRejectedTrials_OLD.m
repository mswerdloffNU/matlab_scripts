...
x = x9;
% n = 0; % this is the condition/session to which you're going to assign the rejected trials
n = n+1;
for i = 1:numel(x) 
    S003(x(i),n) = 1;
end
S003_rejectedTrials = array2table(S003, 'VariableNames',{'S003_sit_A','S003_sit_B','S003_sit_C','S003_stand_A','S003_stand_B','S003_stand_C','S003_walk_A','S003_walk_B','S003_walk_C'});


for a = 1:9
    numS003(a) = numel(find(S003(:,a)));
end

%% S005
ERP = pop_loaderp('filename', 'erpset_S005_v2_stand_walk_sit_C_0001_filt_a_b_2_allTrials_ICA_Num.erp',...
...
S005_rejectedTrials = array2table(rejTrials, 'VariableNames',{'sit_A','sit_B','sit_C','stand_A','stand_B','stand_C','walk_A','walk_B','walk_C'});


for a = 1:9
    numS005(a) = numel(find(rejTrials(:,a)));
end

%% S006
ERP = pop_loaderp('filename', 'erpset_S006_stand_walk_sit_C_0001_filt_a_b_2_allTrials_ICA_Num.erp',...
...
S006_rejectedTrials = array2table(rejTrials, 'VariableNames',{'sit_A','sit_B','sit_C','stand_A','stand_B','stand_C','walk_A','walk_B','walk_C'});

%%
for a = 1:9
    numS006(a) = numel(find(rejTrials(:,a)));
end

%% S007
%1
ERP = pop_loaderp('filename', 'erpset_S007_walk_stand_sit_A_0002_filt_a_b_2_allTrials_ICA_Num.erp',...
    'filepath', 'Z:\Lab Member Folders\Margaret Swerdloff\EEG-gait\EEG\Matlab_data\Pilot2\S007\sit\');
%2
ERP = pop_loaderp('filename', 'erpset_S007_stand_sit_walk_B_0001_filt_a_b_2_allTrials_ICA_Num.erp',...
    'filepath', 'Z:\Lab Member Folders\Margaret Swerdloff\EEG-gait\EEG\Matlab_data\Pilot2\S007\sit\');
%3
ERP = pop_loaderp('filename', 'erpset_S007_sit_walk_stand_C_filt_a_b_2_allTrials_ICA_Num.erp',...
    'filepath', 'Z:\Lab Member Folders\Margaret Swerdloff\EEG-gait\EEG\Matlab_data\Pilot2\S007\sit\');
%4
ERP = pop_loaderp('filename', 'erpset_S007_walk_stand_sit_A_0001_filt_a_b_2_allTrials_ICA_Num.erp',...
    'filepath', 'Z:\Lab Member Folders\Margaret Swerdloff\EEG-gait\EEG\Matlab_data\Pilot2\S007\stand\');
%5
ERP = pop_loaderp('filename', 'erpset_S007_stand_sit_walk_B_filt_a_b_2_allTrials_ICA_Num.erp',...
    'filepath', 'Z:\Lab Member Folders\Margaret Swerdloff\EEG-gait\EEG\Matlab_data\Pilot2\S007\stand\');
%6
ERP = pop_loaderp('filename', 'erpset_S007_sit_walk_stand_C_0002_filt_a_b_2_allTrials_ICA_Num.erp',...
    'filepath', 'Z:\Lab Member Folders\Margaret Swerdloff\EEG-gait\EEG\Matlab_data\Pilot2\S007\stand\');
%7
ERP = pop_loaderp('filename', 'erpset_S007_walk_stand_sit_A_filt_a_b_2_allTrials_ICA_Num.erp',...
    'filepath', 'Z:\Lab Member Folders\Margaret Swerdloff\EEG-gait\EEG\Matlab_data\Pilot2\S007\walk\');
%8
ERP = pop_loaderp('filename', 'erpset_S007_stand_sit_walk_B_0002_filt_a_b_2_allTrials_ICA_Num.erp',...
    'filepath', 'Z:\Lab Member Folders\Margaret Swerdloff\EEG-gait\EEG\Matlab_data\Pilot2\S007\walk\');
%9
ERP = pop_loaderp('filename', 'erpset_S007_sit_walk_stand_C_0001_filt_a_b_2_allTrials_ICA_Num.erp',...
    'filepath', 'Z:\Lab Member Folders\Margaret Swerdloff\EEG-gait\EEG\Matlab_data\Pilot2\S007\walk\');
...
S007_rejectedTrials = array2table(rejTrials, 'VariableNames',{'sit_A','sit_B','sit_C','stand_A','stand_B','stand_C','walk_A','walk_B','walk_C'});

%%
for a = 1:9
    numS007(a) = numel(find(rejTrials(:,a)));
end

%% S008
%1
ERP = pop_loaderp('filename', 'erpset_S008_sit_walk_stand_A_filt_a_b_2_allTrials_ICA_Num.erp',...
    'filepath', 'Z:\Lab Member Folders\Margaret Swerdloff\EEG-gait\EEG\Matlab_data\Pilot2\S008\sit\');
%2
ERP = pop_loaderp('filename', 'erpset_S008_walk_stand_sit_B_0002_filt_a_b_2_allTrials_ICA_Num.erp',...
    'filepath', 'Z:\Lab Member Folders\Margaret Swerdloff\EEG-gait\EEG\Matlab_data\Pilot2\S008\sit\');
%3
ERP = pop_loaderp('filename', 'erpset_S008_stand_sit_walk_C_0001_filt_a_b_2_allTrials_ICA_Num.erp',...
    'filepath', 'Z:\Lab Member Folders\Margaret Swerdloff\EEG-gait\EEG\Matlab_data\Pilot2\S008\sit\');
%4
ERP = pop_loaderp('filename', 'erpset_S008_sit_walk_stand_A_0002_filt_a_b_2_allTrials_ICA_Num.erp',...
    'filepath', 'Z:\Lab Member Folders\Margaret Swerdloff\EEG-gait\EEG\Matlab_data\Pilot2\S008\stand\');
%5
ERP = pop_loaderp('filename', 'erpset_S008_walk_stand_sit_B_0001_filt_a_b_2_allTrials_ICA_Num.erp',...
    'filepath', 'Z:\Lab Member Folders\Margaret Swerdloff\EEG-gait\EEG\Matlab_data\Pilot2\S008\stand\');
%6
ERP = pop_loaderp('filename', 'erpset_S008_stand_sit_walk_C_filt_a_b_2_allTrials_ICA_Num.erp',...
    'filepath', 'Z:\Lab Member Folders\Margaret Swerdloff\EEG-gait\EEG\Matlab_data\Pilot2\S008\stand\');
%7
ERP = pop_loaderp('filename', 'erpset_S008_sit_walk_stand_A_0001_filt_a_b_2_allTrials_ICA_Num.erp',...
    'filepath', 'Z:\Lab Member Folders\Margaret Swerdloff\EEG-gait\EEG\Matlab_data\Pilot2\S008\walk\');
%8
ERP = pop_loaderp('filename', 'erpset_S008_walk_stand_sit_B_filt_a_b_2_allTrials_ICA_Num.erp',...
    'filepath', 'Z:\Lab Member Folders\Margaret Swerdloff\EEG-gait\EEG\Matlab_data\Pilot2\S008\walk\');
%9
ERP = pop_loaderp('filename', 'erpset_S008_stand_sit_walk_C_0002_filt_a_b_2_allTrials_ICA_Num.erp',...
    'filepath', 'Z:\Lab Member Folders\Margaret Swerdloff\EEG-gait\EEG\Matlab_data\Pilot2\S008\walk\');
...
x3 = [11 32 60 61 95 97 116 118 146 164 173 182 189 207 216 219 252 264 278];
...
S008_rejectedTrials = array2table(rejTrials, 'VariableNames',{'sit_A','sit_B','sit_C','stand_A','stand_B','stand_C','walk_A','walk_B','walk_C'});

%%
for a = 1:9
    numS008(a) = numel(find(rejTrials(:,a)));
end

%% S009
%1
ERP = pop_loaderp('filename', 'erpset_S009_stand_sit_walk_A_0001_filt_a_b_2_allTrials_ICA_Num.erp',...
    'filepath', 'Z:\Lab Member Folders\Margaret Swerdloff\EEG-gait\EEG\Matlab_data\Pilot2\S009\sit\');
%2
ERP = pop_loaderp('filename', 'erpset_S009_sit_walk_stand_B_filt_a_b_2_allTrials_ICA_Num.erp',...
    'filepath', 'Z:\Lab Member Folders\Margaret Swerdloff\EEG-gait\EEG\Matlab_data\Pilot2\S009\sit\');
%3
ERP = pop_loaderp('filename', 'erpset_S009_walk_stand_sit_C_0002_filt_a_b_2_allTrials_ICA_Num.erp',...
    'filepath', 'Z:\Lab Member Folders\Margaret Swerdloff\EEG-gait\EEG\Matlab_data\Pilot2\S009\sit\');
%4
ERP = pop_loaderp('filename', 'erpset_S009_stand_sit_walk_A_filt_a_b_2_allTrials_ICA_Num.erp',...
    'filepath', 'Z:\Lab Member Folders\Margaret Swerdloff\EEG-gait\EEG\Matlab_data\Pilot2\S009\stand\');
%5
ERP = pop_loaderp('filename', 'erpset_S009_sit_walk_stand_B_0002_filt_a_b_2_allTrials_ICA_Num.erp',...
    'filepath', 'Z:\Lab Member Folders\Margaret Swerdloff\EEG-gait\EEG\Matlab_data\Pilot2\S009\stand\');
%6
ERP = pop_loaderp('filename', 'erpset_S009_walk_stand_sit_C_0001_filt_a_b_2_allTrials_ICA_Num.erp',...
    'filepath', 'Z:\Lab Member Folders\Margaret Swerdloff\EEG-gait\EEG\Matlab_data\Pilot2\S009\stand\');
%7
ERP = pop_loaderp('filename', 'erpset_S009_stand_sit_walk_A_0002_filt_a_b_2_allTrials_ICA_Num.erp',...
    'filepath', 'Z:\Lab Member Folders\Margaret Swerdloff\EEG-gait\EEG\Matlab_data\Pilot2\S009\walk\');
%8
ERP = pop_loaderp('filename', 'erpset_S009_sit_walk_stand_B_0001_filt_a_b_2_allTrials_ICA_Num.erp',...
    'filepath', 'Z:\Lab Member Folders\Margaret Swerdloff\EEG-gait\EEG\Matlab_data\Pilot2\S009\walk\');
%9
ERP = pop_loaderp('filename', 'erpset_S009_walk_stand_sit_C_filt_a_b_2_allTrials_ICA_Num.erp',...
    'filepath', 'Z:\Lab Member Folders\Margaret Swerdloff\EEG-gait\EEG\Matlab_data\Pilot2\S009\walk\');
...
S009_rejectedTrials = array2table(rejTrials, 'VariableNames',{'sit_A','sit_B','sit_C','stand_A','stand_B','stand_C','walk_A','walk_B','walk_C'});

%%
for a = 1:9
    numS009(a) = numel(find(rejTrials(:,a)));
end
...
for i = 1:1 % make sure to run this all together (only once)
    ...
    for i = 1:9
        ...
        totalAccepted(i) = 300-numel(find(x_all(:,i)));
        targetsAccepted(i) = 30-numel(find(x_all(:,i)==1));
    end
end
...
%%
targetsAccepted_all = [targetsAccepted_all_S003;targetsAccepted_all_S005;targetsAccepted_all_S006;targetsAccepted_all_S007;targetsAccepted_all_S008;targetsAccepted_all_S009;targetsAccepted_all_S010;targetsAccepted_all_S012;targetsAccepted_all_S013;targetsAccepted_all_S014];
TargetsAccepted = array2table(targetsAccepted_all,'VariableNames',{'Sit','Stand','Walk','Min'},'RowNames',{'S003','S005','S006','S007','S008','S009','S010','S012','S013','S014'});
totalAccepted_all = [totalAccepted_all_S003;totalAccepted_all_S005;totalAccepted_all_S006;totalAccepted_all_S007;totalAccepted_all_S008;totalAccepted_all_S009;totalAccepted_all_S010;totalAccepted_all_S012;totalAccepted_all_S013;totalAccepted_all_S014];
TotalAccepted = array2table(totalAccepted_all,'VariableNames',{'Sit','Stand','Walk','Min'},'RowNames',{'S003','S005','S006','S007','S008','S009','S010','S012','S013','S014'});
...
list=find(table2array(S008_rejectedTrials(:,1:3))==0);
s = RandStream('mlfg6331_64');
reject = randsample(numel(list),numel(list)-minTrials(Sn));
newlist=list;
newlist(reject)=0;

for i = 1:numel(list)
    if newlist(i) == 0 && list(i) < 301
        b = list(i);
        rejectedTrials_new(b,1)=1;
    elseif newlist(i) == 0 && list(i) > 600
        b = list(i)-600;
        rejectedTrials_new(b,3)=1;
    elseif newlist(i) == 0 && list(i) < 601 && list(i) > 300
        b = list(i)-300;
...
clear list s reject newlist b 
list=find(table2array(S008_rejectedTrials(:,4:6))==0);
s = RandStream('mlfg6331_64');
reject = randsample(numel(list),numel(list)-minTrials(Sn));
newlist=list;
newlist(reject)=0;
...
clear list s reject newlist b 
list=find(table2array(S008_rejectedTrials(:,7:9))==0);
s = RandStream('mlfg6331_64');
reject = randsample(numel(list),numel(list)-minTrials(Sn));
newlist=list;
newlist(reject)=0;
