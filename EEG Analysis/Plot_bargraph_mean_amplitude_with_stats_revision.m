...
for i = 1:4
    ...
    if i == 4
        averagedERPmean_medFont_bwSafe_rev(time, [sit_grandAvg; stand_grandAvg; walk_grandAvg], [0 0], [-10 10], [-200 800], [sit_SEM_m(1:1:300) sit_SEM_p(300:-1:1)],[time(1:1:300) time(300:-1:1)],[stand_SEM_m(1:1:300) stand_SEM_p(300:-1:1)],[walk_SEM_m(1:1:300) walk_SEM_p(300:-1:1)])
    else
        averagedERPmean_medFont_bwSafe_revABC(time, [sit_grandAvg; stand_grandAvg; walk_grandAvg], [0 0], [-13 13], [-200 800], [sit_SEM_m(1:1:300) sit_SEM_p(300:-1:1)],[time(1:1:300) time(300:-1:1)],[stand_SEM_m(1:1:300) stand_SEM_p(300:-1:1)],[walk_SEM_m(1:1:300) walk_SEM_p(300:-1:1)])
    end
end
