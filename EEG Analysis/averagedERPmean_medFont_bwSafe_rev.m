function averagedERPmean_medFont_bwSafe_rev(X1, YMatrix1, XData1, YData1, XData2, YData2, XData3, YData3, YData4)
...
%'Color',[.5 1 .5]);
set(plot1(3),'DisplayName','Walk','LineStyle','-','Color',[1 .5 .5]);

% Create line
line(XData1,YData1,'Parent',axes1,'LineWidth',2,'LineStyle','--','Color','k');

% Create line
line(XData2,XData1,'Parent',axes1,'LineWidth',2,'LineStyle','--','Color','k');
...
% Create xlabel
xlabel('Time relative to stimuli (ms)','FontSize',22,...
    'FontName','Times New Roman','Position',[300.00047683715826 -12.409909833390437 0]);

% Create ylabel
ylabel('Potential (µV)','FontSize',22,'FontName','Times New Roman','Position',[-287.4655620289902 9.5367431640625E-6 0]);
...
legend1 = legend('Sit','Stand','Walk');
legend boxoff
set(legend1,'Orientation','horizontal','Position',[0.37007537218970155 0.22698412757544287 0.5455635413348818 0.13333333002196432]);
