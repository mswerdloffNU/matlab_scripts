...
filename_duration = 'Maggie_Sit_TTHigh_ArduinoRecording_15min_1sISI_375msjitter_duration_raw.csv';
...
filename = 'Maggie_Sit_TTHigh_ArduinoRecording_15min_1sISI_375msjitter_raw.csv';
...
fileID = fopen('Maggie_Sit_TTHigh_ArduinoRecording_15min_1sISI_375msjitter2.txt');
...
tones = [240;4;4;4;tonesAndTimes(1:2:end)];
...
% initialize using the first 5 times that the DSI picked up tones and zeros
    clear timeArd_all
    timeArd_all = [timeDSI(1:5);zeros(length(timeDSI)-5,1)]; 
