...
filename = 'Maggie_WalkTreadmill_TTHigh_ArduinoRecording_10min_1sISI_postSitWalk_raw.csv';
...
cd 'Z:\Lab Member Folders\Margaret Swerdloff\EEG-gait\EEG\Matlab_data\EEG_data_withTriggers\1_30Hz'
...
fileID = fopen('Maggie_WalkTreadmill_TTHigh_ArduinoRecording_10min_1sISI_postSitWalk_tones_and_times.txt');
...
cd 'Z:\Lab Member Folders\Margaret Swerdloff\EEG-gait\EEG\Matlab_data\EEG_data_withTriggers\1_30Hz'
str_mat = strrep(filename,'_raw.csv','_raw_1_30Hz.mat'); % table of EEG data (.mat)
...
cd 'Z:\Lab Member Folders\Margaret Swerdloff\EEG-gait\EEG\Matlab_data\EEG_data_withTriggers\1_30Hz'
str_mat = strrep(filename,'_raw.csv','_raw_eqNumTrials_1_30Hz.mat'); % table of EEG data with equalized number of trials(.mat)
...
%% save filtered EEG data
cd 'Z:\Lab Member Folders\Margaret Swerdloff\EEG-gait\EEG\Matlab_data\EEG_data_withTriggers\1_30Hz'
str_mat = strrep(filename,'_raw.csv','_filt_a_b_1_eqNumTrials_1_30Hz.mat'); % table of EEG data (.mat)
save(str_mat,'tbl_filt_a_b_1_tr'); % save b,a butter -> filtfilt filtered data
str_mat = strrep(filename,'_raw.csv','_filt_a_b_2_eqNumTrials_1_30Hz.mat'); % table of EEG data (.mat)
save(str_mat,'tbl_filt_a_b_2_tr'); % save b,a butter -> filtfilt filtered data
str_mat = strrep(filename,'_raw.csv','_filt_a_b_4_eqNumTrials_1_30Hz.mat'); % table of EEG data (.mat)
