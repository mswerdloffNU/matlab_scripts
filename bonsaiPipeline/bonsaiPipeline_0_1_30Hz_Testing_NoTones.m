...
%% save raw EEG data
tbl_raw = [Pz_LE,F4_LE,C4_LE,P4_LE,P3_LE,C3_LE,F3_LE,Event]'; % create tbl
cd 'Z:\Lab Member Folders\Margaret Swerdloff\EEG-gait\EEG\Matlab_data\EEG_data_withTriggers\0_1_30Hz_Testing'
...
cd 'Z:\Lab Member Folders\Margaret Swerdloff\EEG-gait\EEG\Matlab_data\EEG_data_withTriggers\0_1_30Hz_Testing'
str_mat = strrep(filename,'_raw.csv','_raw_0_1_30Hz_Testing.mat'); % table of EEG data (.mat)
...
cd 'Z:\Lab Member Folders\Margaret Swerdloff\EEG-gait\EEG\Matlab_data\EEG_data_withTriggers\0_1_30Hz_Testing'
str_mat = strrep(filename,'_raw.csv','_raw_eqNumTrials_0_1_30Hz_Testing.mat'); % table of EEG data with equalized number of trials(.mat)
...
%% save filtered EEG data
cd 'Z:\Lab Member Folders\Margaret Swerdloff\EEG-gait\EEG\Matlab_data\EEG_data_withTriggers\0_1_30Hz_Testing'
str_mat = strrep(filename,'_raw.csv','_filt_a_b_1_eqNumTrials_0_1_30Hz_Testing.mat'); % table of EEG data (.mat)
save(str_mat,'tbl_filt_a_b_1_tr'); % save b,a butter -> filtfilt filtered data
str_mat = strrep(filename,'_raw.csv','_filt_a_b_2_eqNumTrials_0_1_30Hz_Testing.mat'); % table of EEG data (.mat)
save(str_mat,'tbl_filt_a_b_2_tr'); % save b,a butter -> filtfilt filtered data
str_mat = strrep(filename,'_raw.csv','_filt_a_b_4_eqNumTrials_0_1_30Hz_Testing.mat'); % table of EEG data (.mat)
