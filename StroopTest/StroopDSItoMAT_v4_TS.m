...
for mm = 1:2
    if mm == 1
        ...
        filename = 'Sub_v9_mix_pt1_stroopStimuli_duration_raw.csv'; %'Sub_stroopStimuli_v2_unRand_adj_allEasy_v5_S005_day5_duration_raw.csv'; %'Maggie_stroopStimuli_v2_unRand_adj_allEasy_v4_AB00_raw.csv' %'MaggieStroopAudio1_0001_duration_raw.csv';
    elseif mm==2
...
% end
       ...
       clear nearestProvTones idxNearestProvTones nearestProvTone_easy idxNearestProvTone_easy
        ...
        for ii = 1:length(nearestProvTone)
            idxNearestProvTone(ii) = 8 + (ii-1)*15;
        end
