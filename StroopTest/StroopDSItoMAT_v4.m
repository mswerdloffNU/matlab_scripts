...
for mm = 1:2
    if mm == 1
        level = 'v5';
        stroop_data_sub = 'Sub_v5.mat'; %'S018_Test3unRand_adj_Easy_v6_hard.mat'; %'AB00_Test1 - MMS data.mat';
        filename = 'Sub_v5_stroopStimuli_duration_raw.csv'; %'Maggie_stroopStimuli_v2_unRand_adj_allEasy_v4_AB00_raw.csv' %'MaggieStroopAudio1_0001_duration_raw.csv';
    elseif mm==2
        level = 'v6_hard';
        stroop_data_sub = 'Sub_v6_hard.mat'; %'S018_Test3unRand_adj_Easy_v6_hard.mat'; %'AB00_Test1 - MMS data.mat';
        filename = 'Sub_v6_hard_stroopStimuli_duration_raw.csv'; %'Maggie_stroopStimuli_v2_unRand_adj_allEasy_v4_AB00_raw.csv' %'MaggieStroopAudio1_0001_duration_raw.csv';
    end
    for i = 1:numel(subs)
        %% load files
