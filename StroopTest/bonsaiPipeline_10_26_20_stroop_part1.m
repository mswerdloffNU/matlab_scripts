...
for ii = 1:numel(subs)
    ...
    if n == 1
        ...
        filename = 'Sub_v9_mix_pt1_stroopStimuli.dsi';
    elseif n == 2
        level = 'v9_mix_pt2'; %'v6_hard_day5';
        filename = 'Sub_v9_mix_pt2_stroopStimuli.dsi';
    end
    ...
    fnameLoc = 'Z:\Lab Member Folders\Margaret Swerdloff\EEG_gait\EEG\Matlab_data\StroopAudio\Testing\';
