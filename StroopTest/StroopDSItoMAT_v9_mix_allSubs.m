...
%         level = 'v9_mix_pt1'; %'v5_day5';
        ...
        filename = 'Sub_SA_duration_raw.csv'; %'Sub_stroopStimuli_v2_unRand_adj_allEasy_v5_S005_day5_duration_raw.csv'; %'Maggie_stroopStimuli_v2_unRand_adj_allEasy_v4_AB00_raw.csv' %'MaggieStroopAudio1_0001_duration_raw.csv';
%     elseif mm==2
