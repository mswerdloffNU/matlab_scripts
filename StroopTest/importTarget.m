function S003v2sitwalkstandAfiltab2allTrialsICANumTarget = importTarget(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   S003V2SITWALKSTANDAFILTAB2ALLTRIALSICANUMTARGET = IMPORTFILE(FILENAME)
...
%
% Example:
%   S003v2sitwalkstandAfiltab2allTrialsICANumTarget = importfile('S003_v2_sit_walk_stand_A_filt_a_b_2_allTrials_ICA_Num_Target.txt', 1, 8);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2019/07/31 10:04:42
...
formatSpec = '%s%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%[^\n\r]';
