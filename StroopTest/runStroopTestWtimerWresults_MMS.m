function t=runStroopTestWtimerWresults(totalRunTime,sPortObj,Congruence,FigHdl,sfc)
...
%% Create Timer
%      secondsFigureChange = 1;
%     secondsFigureChange = secondsFigureChange_all(n)
     secondsFigureChange = sfc
